...
export const initialUsers: User[] = [
  {
    ...
    cover: '/lan-party/roxo.JPG', scores: {}, history: [0], predictionPoints: 0
  },
  {
    ...
    cover: '/lan-party/noyas.JPG', scores: {}, history: [0], predictionPoints: 0
  },
  {
    ...
    cover: '/lan-party/danis.jpg', scores: {}, history: [0], predictionPoints: 0
  },
  {
    ...
    cover: '/lan-party/pablo.JPG', scores: {}, history: [0], predictionPoints: 0
  }
];
...
/**
 * Maps each player's Firebase auth email to their player ID.
