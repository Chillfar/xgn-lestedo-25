...
export const titleContainerSx = { width: "auto", height: "auto", borderRadius: "8px", display: "flex", padding: "8px", alignItems: "center", justifyContent: "center", marginBottom: "12px" };
