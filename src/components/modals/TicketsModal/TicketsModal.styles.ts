...
export const modalBoxSx = { position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: 1300, bgcolor: "#1e1e1e", color: "white", boxShadow: 24, p: 4, borderRadius: 2, height: "85%", overflowY: "scroll", scrollbarWidth: "thin", scrollbarColor: "#F363FA #1e1e1e" };
...
export const imgSx: CSSProperties = { marginRight: '16px', width: "310px", height: "auto", borderRadius: "8px" };
export const imgLastSx: CSSProperties = { width: "310px", height: "auto", borderRadius: "8px" };
