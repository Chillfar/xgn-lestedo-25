...
export const modalBoxSx = { position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: "min(480px, 95vw)", bgcolor: "#1e1e1e", color: "white", boxShadow: 24, p: 3, borderRadius: 2 };
...
export const descSx = { mt: 2, fontSize: "0.85rem", color: "rgba(255,255,255,0.8)" };
