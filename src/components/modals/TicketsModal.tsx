  ...
  return (
    <Modal open={open} onClose={onClose}>
      <Box sx={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: 1300, bgcolor: "#1e1e1e", color: "white", boxShadow: 24, p: 4, borderRadius: 2, height: "85%", overflowY: "scroll", scrollbarWidth: "thin", scrollbarColor: "#F363FA #1e1e1e" }}>
        ...
        <img src={'/xgn-lestedo-25/acreditacion-chillfar.jpg'} alt={'Acreditación Chillfar'} style={{ marginRight: '16px', width: "310px", height: "auto", borderRadius: "8px" }} />
        <img src={'/xgn-lestedo-25/acreditacion-eras.jpg'} alt={'Acreditación Eras'} style={{ marginRight: '16px', width: "310px", height: "auto", borderRadius: "8px" }} />
        <img src={'/xgn-lestedo-25/acreditacion-goku.jpg'} alt={'Acreditación Goku'} style={{ marginRight: '16px', width: "310px", height: "auto", borderRadius: "8px" }} />
        <img src={'/xgn-lestedo-25/acreditacion-noyas.jpg'} alt={'Acreditación Noyas'} style={{ width: "310px", height: "auto", borderRadius: "8px" }} />
      </Box>
    </Modal>
  );
}
