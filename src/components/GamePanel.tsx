...
export default function GamePanel({ games, isMobile, onGameClick, onAddGameClick }: GamePanelProps) {
          ...
          {games.map((game, index) => (
            <Grid item xs={6} key={index}>
              <Card onClick={() => onGameClick(game)} style={{ cursor: "pointer", textAlign: "center", backgroundColor: "#2a2a2a", color: "white" }}>
                <CardContent>
                  <img src={game.cover} alt={game.name} style={{ width: "100%", height: "180px", objectFit: "cover", borderRadius: "8px" }} loading="lazy" />
